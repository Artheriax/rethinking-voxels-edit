...
void main() {
        ...
        // FIX: Update more frequently (1/4 instead of 1/10) to reduce flickering
        bool doLighting = (frameCounter + gl_WorkGroupID.x + gl_WorkGroupID.y + gl_WorkGroupID.z) % 4 == 0;
        vec4 irrCacheData[7];
