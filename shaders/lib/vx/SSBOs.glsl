...
// Precision epsilon for safe divisions and comparisons
#define VX_EPSILON 0.0001
...
// Buffer binding 1: Volume pointer storage
// Note: This buffer is defined but accessed via pointerVolumeI 3D image instead
// Keeping for SSBO binding compatibility
layout(std430, binding = 1) WRITE_TO_SSBOS buffer volumePointers {
        int _volumePointersPadding;
        // Access via readVolumePointer/writeVolumePointer functions using pointerVolumeI
};
